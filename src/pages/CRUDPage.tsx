  ...
  return (
    <div className="w-full p-4 overflow-x-auto">
      <section className="flex justify-center items-center mb-4 gap-5">
        <button className="block p-1 rounded transition ease-in-out delay-75 bg-brand-light-accent text-brand-light-shades hover:bg-brand-light-accent-600"><SearchIcon width={28} height={28}/></button>
        <input className="border-2 border-brand-light-accent px-2 py-1 rounded outline-none" type="text" />
