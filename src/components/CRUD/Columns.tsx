...
export const Columns: ColumnDef<products>[] = [
    ...
    cell: ({ row }) => {
      ...
      return (
        <section className='flex justify-center w-fit border rounded-[100px] z-50'>
          <CRUDButton Icon={<ReadIcon width={28} height={28} />} bgColor="Read" productId={idProducto} />
          <CRUDButton Icon={<UpdateIcon width={28} height={28} />} bgColor="Update" productId={idProducto} />
          <CRUDButton Icon={<DeleteIcon width={28} height={28} />} bgColor="Delete" productId={idProducto} />
        </section>          
      )
    }
  },
  {
    ...
    header: () => <div className="w-fit text-xs sm:text-sm md:text-lg">IDProducto</div>,
  },
  {
    accessorKey: "imagen",
    ...
    cell: ({ row }) => {
      ...
      return <div> <img className="w-12 h-12" src={imgSource} alt="" /> </div>
    },
  },
  {
